...
100.times do
  ...
  pp location
  bot = User.new(password: "password", first_name: Faker::Name.first_name, zipcode: location.zipcode, latitude: location.latitude, longitude: location.longitude, profile_picture: HTTP.get("https://api.scryfall.com/cards/random").parse()["image_uris"]["art_crop"], age: rand(21..39))
  pp bot
